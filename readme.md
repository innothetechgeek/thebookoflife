...
- [Simple, fast routing engine](""/routing).
- [Powerful dependency injection container](""/container).
- Multiple back-ends for [session](""/session) and [cache](""/cache) storage.
- Expressive, intuitive [database ORM](""/eloquent).
- Database agnostic [schema migrations](""/migrations).
